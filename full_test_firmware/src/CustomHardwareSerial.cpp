...
// Constructors ////////////////////////////////////////////////////////////////
CustomHardwareSerial::CustomHardwareSerial(uint32_t _rx, uint32_t _tx, uint32_t _rts, uint32_t _cts)
{
  init(digitalPinToPinName(_rx), digitalPinToPinName(_tx), digitalPinToPinName(_rts), digitalPinToPinName(_cts));
}

CustomHardwareSerial::CustomHardwareSerial(PinName _rx, PinName _tx, PinName _rts, PinName _cts)
{
  init(_rx, _tx, _rts, _cts);
}

CustomHardwareSerial::CustomHardwareSerial(void *peripheral, HalfDuplexMode_t halfDuplex)
{
...
CustomHardwareSerial::CustomHardwareSerial(uint32_t _rxtx)
{
  init(NC, digitalPinToPinName(_rxtx));
}

CustomHardwareSerial::CustomHardwareSerial(PinName _rxtx)
{
  init(NC, _rxtx);
}

void CustomHardwareSerial::init(PinName _rx, PinName _tx, PinName _rts, PinName _cts)
{
  if (_rx == _tx) {
    _serial.pin_rx = NC;
  } else {
...
void CustomHardwareSerial::configForLowPower(void)
{
...
void CustomHardwareSerial::_rx_complete_irq(serial_t *obj)
{
...
int CustomHardwareSerial::_tx_complete_irq(serial_t *obj)
{
  ...
  if (obj->tx_head != obj->tx_tail) {
    ...
    //TX buffer is empty, need to switch RS485 transciever back to receive mode
    if (_custom_tx_callback != nullptr) _custom_tx_callback(obj);
  }
...
void CustomHardwareSerial::attach_custom_tx_callback(void (*callback)(serial_t *)) {
  _custom_tx_callback = callback;
}

// Public Methods //////////////////////////////////////////////////////////////

void CustomHardwareSerial::begin(unsigned long baud, byte config)
{
  uint32_t databits = 0;
  uint32_t stopbits = 0;
  uint32_t parity = 0;
...
int CustomHardwareSerial::read(void)
{
  enableHalfDuplexRx();
...
int CustomHardwareSerial::availableForWrite(void)
{
...
void CustomHardwareSerial::flush()
{
  flush(0);
}

void CustomHardwareSerial::flush(uint32_t timeout)
{
...
size_t CustomHardwareSerial::write(const uint8_t *buffer, size_t size)
{
...
size_t CustomHardwareSerial::write(uint8_t c)
{
  uint8_t buff = c;
  return write(&buff, 1);
}

void CustomHardwareSerial::setRx(uint32_t _rx)
{
  _serial.pin_rx = digitalPinToPinName(_rx);
}

void CustomHardwareSerial::setTx(uint32_t _tx)
{
  _serial.pin_tx = digitalPinToPinName(_tx);
}

void CustomHardwareSerial::setRx(PinName _rx)
{
  _serial.pin_rx = _rx;
}

void CustomHardwareSerial::setTx(PinName _tx)
{
  _serial.pin_tx = _tx;
}

void CustomHardwareSerial::setRts(uint32_t _rts)
{
  _serial.pin_rts = digitalPinToPinName(_rts);
}

void CustomHardwareSerial::setCts(uint32_t _cts)
{
  _serial.pin_cts = digitalPinToPinName(_cts);
}

void CustomHardwareSerial::setRtsCts(uint32_t _rts, uint32_t _cts)
{
  _serial.pin_rts = digitalPinToPinName(_rts);
  _serial.pin_cts = digitalPinToPinName(_cts);
}

void CustomHardwareSerial::setRts(PinName _rts)
{
  _serial.pin_rts = _rts;
}

void CustomHardwareSerial::setCts(PinName _cts)
{
  _serial.pin_cts = _cts;
}

void CustomHardwareSerial::setRtsCts(PinName _rts, PinName _cts)
{
  _serial.pin_rts = _rts;
  _serial.pin_cts = _cts;
}

void CustomHardwareSerial::setHalfDuplex(void)
{
  _serial.pin_rx = NC;
}

bool CustomHardwareSerial::isHalfDuplex(void) const
{
  return _serial.pin_rx == NC;
}

void CustomHardwareSerial::enableHalfDuplexRx(void)
{
  if (isHalfDuplex()) {
